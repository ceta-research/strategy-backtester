#!/usr/bin/env python3
"""trending_value walk-forward harness."""
...
CHAMPION = "strategies/trending_value/config_champion.yaml"
...
def run_fold(label, start_epoch, end_epoch, provider):
    ...
    tmp = Path("/tmp/tv_wf_configs"); tmp.mkdir(exist_ok=True)
...
def main():
    ...
    out = "results/trending_value/round4_walkforward.json"
