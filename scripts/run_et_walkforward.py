#!/usr/bin/env python3
"""eod_technical walk-forward harness."""
...
CHAMPION = "strategies/eod_technical/config_champion.yaml"
...
def run_fold(label, start_epoch, end_epoch, provider):
    ...
    tmp = Path("/tmp/et_wf"); tmp.mkdir(exist_ok=True)
...
def main():
    ...
    out = "results/eod_technical/round4_walkforward.json"
