#!/usr/bin/env python3
"""quality_dip_tiered walk-forward harness. Same pattern as run_qdb/fsd/fc_walkforward.py."""
...
CHAMPION = "strategies/quality_dip_tiered/config_champion.yaml"
...
def run_fold(label, start_epoch, end_epoch, provider):
    ...
    tmp = Path("/tmp/qdt_wf_configs"); tmp.mkdir(exist_ok=True)
...
def main():
    ...
    out = "results/quality_dip_tiered/round4_walkforward.json"
