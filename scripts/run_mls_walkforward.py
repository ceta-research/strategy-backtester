#!/usr/bin/env python3
"""ml_supertrend walk-forward harness — 5-fold 3-yr rolling (standard)."""
...
CHAMPION = "strategies/ml_supertrend/config_champion.yaml"
...
def run_fold(label, start_epoch, end_epoch, provider):
    ...
    tmp = Path("/tmp/mls_wf_configs"); tmp.mkdir(exist_ok=True)
...
def main():
    ...
    out = "results/ml_supertrend/round4_walkforward.json"
