#!/usr/bin/env python3
"""factor_composite walk-forward harness. Same pattern as run_qdb/fsd_walkforward.py."""
...
CHAMPION = "strategies/factor_composite/config_champion.yaml"
...
def run_fold(label, start_epoch, end_epoch, provider):
    ...
    tmp = Path("/tmp/fc_wf_configs"); tmp.mkdir(exist_ok=True)
...
def main():
    ...
    out = "results/factor_composite/round4_walkforward.json"
